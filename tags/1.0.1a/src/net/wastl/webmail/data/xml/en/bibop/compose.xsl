        ...
        <FORM ACTION="{$base}/send?session-id={$session-id}" METHOD="POST">
          <TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
            <TR>
              ...
              Composing a message... (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=compose">Help</A>)
                </TD>
            </TR>
            <TR>
           ...
           <TR>
             <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">From:</TD>
            ...
            <TR>
              <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">To:</TD>
              <TD height="22" class="testoNero" width="87%" bgcolor="#E2E6F0">
