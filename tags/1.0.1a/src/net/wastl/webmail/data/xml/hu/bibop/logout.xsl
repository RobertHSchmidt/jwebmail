              ...
              <TABLE width="400" border="0" cellspacing="0" cellpadding="0" height="250">
                ...
                <TR>
                  <TD align="center" bgcolor="#FFFFFF" width="315" class="testo">
                    <BR/><SPAN class="testoGrande">Köszönjük, hogy rendszerünket használja!</SPAN><BR/><BR/>
                    <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/> felkészítése a kilépésre.<BR/><BR/>
                  </TD>
                </TR>
                <TR>
