...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" version="1.0">
  <xsl:output method="html" indent="yes" xalan:content-handler="org.apache.xalan.serialize.SerializerToHTML"/>
    ...
    <HTML>
      <HEAD>
        <TITLE>Buz&#243;n de WebMail para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/>: Configuraci&#243;n de buzones</TITLE>
      ...
      <BODY bgcolor="#B5C1CF" topmargin="5" leftmargin="0" marginwidth="0" marginheight="5">
        ...
        <TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
         <FORM ACTION="{$base}/folder/setup?session-id={$session-id}&amp;method=mailbox&amp;add=1" METHOD="POST">
          <TR>
            <TD colspan="4" height="22" class="testoNero">
              <IMG SRC="{$imgbase}/images/icona_folder.gif" align="absmiddle"/>
               Configuraci&#243;n de buzones de WebMail para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/> (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=folder-setup-mailboxes">Ayuda</A>)
            </TD>
           </TR>
           <TR>
          ...
          <TR>
            <TD bgcolor="#A6B1C0" colspan="4" height="22" align="center" class="testoGrande">Borrar buzones</TD>
          </TR>
          <xsl:for-each select="/USERMODEL/USERDATA/MAILHOST">
            <TR>
              ...
              <TD width="25%" class="testoNero" bgcolor="#E2E6F0"><A HREF="{$base}/folder/setup?session-id={$session-id}&amp;method=mailbox&amp;remove={@id}">Borrar</A></TD>
            </TR>
          </xsl:for-each>
          <TR>
            <TD bgcolor="#A6B1C0" colspan="4" height="22" align="center" class="testoGrande">A&#241;adir buzones</TD>
          </TR>
          <TR>
            <TD width="25%" bgcolor="#E2E6F0" class="testoNero">Nombre del buz&#243;n:</TD>
            <TD width="75%" colspan="3" class="testoNero" bgcolor="#D1D7E7">
              <INPUT TYPE="text" SIZE="25" NAME="mbox_name" class="testoNero"/>
            </TD>
          </TR>
          <TR>
            <TD width="25%" class="testoNero" bgcolor="#E2E6F0">Nombre del servidor:</TD>
            <TD width="25%" class="testoNero" bgcolor="#D1D7E7"><INPUT TYPE="text" SIZE="10" NAME="mbox_host" class="testoNero"/>
            </TD>
            <TD width="25%" class="testoNero" bgcolor="#E2E6F0">Protocolo:</TD>
          ...
          <TR>
            <TD width="25%" class="testoNero" bgcolor="#E2E6F0">Usuario:
            </TD>
            <TD width="25%" class="testoNero" bgcolor="#D1D7E7">
              <INPUT TYPE="text" SIZE="10" NAME="mbox_login" class="testoNero"/>
            </TD>
            <TD width="25%" class="testoNero" bgcolor="#E2E6F0">Contrase&#241;a:
            </TD>
            <TD width="25%" class="testoNero" bgcolor="#D1D7E7">
