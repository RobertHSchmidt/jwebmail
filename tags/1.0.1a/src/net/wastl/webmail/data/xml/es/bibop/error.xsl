  ...
  <xsl:output method="html" indent="yes" xalan:content-handler="org.apache.xalan.serialize.SerializerToHTML"/>
    ...
    <HTML>
      ...
      <BODY bgcolor="#B5C1CF" topmargin="5" leftmargin="0" marginwidth="0" marginheight="5">
        <TABLE WIDTH="100%">
          <TR bgcolor="#A6B1C0">
            <TD COLSPAN="2" align="center" class="testoGrande">Ha ocurrido un error</TD>
          </TR>
          <TR>
            <TD class="testoNero"><SPAN class="testoGrande">Mensaje de error</SPAN></TD>
            <TD class="testoNero">
          ...
          <TR>
            <TD COLSPAN="2" ALIGN="center" class="testoNero">
              <TABLE bgcolor="#E2E6F0" WIDTH="80%" BORDER="1">
                <TR>
                  <TD><SPAN class="testoGrande">Volcado de la pila</SPAN><BR/>
                    <PRE>
