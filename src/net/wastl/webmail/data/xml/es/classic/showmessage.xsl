...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <HTML>
      <HEAD>
        <TITLE>Buz&#243;n de JWebMail para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/>: Mostrar mensaje <xsl:value-of select="/USERMODEL/CURRENT[@type='message']/@id"/></TITLE>
      ...
      <TABLE WIDTH="100%">
        <TR>
            ...
            <EM>
              <xsl:choose>
                <xsl:when test="@msgnr &gt; 1">
                  <A HREF="{$base}/folder/showmsg?session-id={$session-id}&amp;folder-id={/USERMODEL/CURRENT[@type='folder']/@id}&amp;message-nr={@msgnr - 1}"><IMG SRC="{$imgbase}/images/arrow-left.png" BORDER="0"/> Mensaje anterior</A>
                </xsl:when>
                <xsl:otherwise><IMG SRC="{$imgbase}/images/arrow-left-disabled.png" BORDER="0"/> Mensaje anterior
                </xsl:otherwise>
              </xsl:choose>
            </EM>
          </TD>
          <TD ALIGN="center" VALIGN="center">
            <EM>
              <A HREF="{$base}/folder/list?session-id={$session-id}&amp;folder-id={/USERMODEL/CURRENT[@type='folder']/@id}&amp;part={/USERMODEL/CURRENT[@type='folder']/@list_part}"><IMG SRC="{$imgbase}/images/arrow-up.png" BORDER="0"/>lista de mensajes</A>
            </EM>
          </TD>
