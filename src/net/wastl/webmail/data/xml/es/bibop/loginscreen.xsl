      ...
      <BODY bgcolor="#ffffff">
        ...
        <P align="center">&#160;</P>
          ...
          <xsl:if test="/GENERICMODEL/STATEDATA/VAR[@name='invalid password']/@value = 'yes'">
            <!-- START invalid pass -->
            <P align="center" class="testo"><SPAN class="bold">Conexi&#243;n fallida</SPAN>. &#161;Las contrase&#241;as no coinciden o el campo del nombre/contrase&#241;a estaba vac&#237;o! El intento ser&#225; registrado.</P>
            <P align="center">&#160;</P>
            <P align="center">&#160;</P>
            <!-- END invalid pass -->
          </xsl:if>
