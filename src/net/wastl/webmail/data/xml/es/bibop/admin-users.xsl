...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" version="1.0">
  <xsl:output method="html" indent="yes" xalan:content-handler="org.apache.xml.serializer.ToHTMLStream"/>
    ...
    <HTML>
      <HEAD>
        <TITLE>Interfaz de administraci&#243;n de WebMail: Configurar usuario</TITLE>
      ...
      <BODY BGCOLOR="white">
        <TABLE WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
          <TR bgcolor="#dddddd">
            <TD COLSPAN="2" ALIGN="center"><FONT SIZE="+1"><STRONG>Seleccionar dominio</STRONG></FONT></TD>
          </TR>
          ...
          <xsl:if test="/GENERICMODEL/STATEDATA/VAR[@name = 'selected domain']/@value !='' and count(/GENERICMODEL/STATEDATA/VAR[@name = 'user']) > 0">
            <TR bgcolor="#dddddd">
              <TD COLSPAN="2" ALIGN="center">
                <FONT SIZE="+1"><STRONG>Usuarios en el dominio <xsl:value-of select="/GENERICMODEL/STATEDATA/VAR[@name = 'selected domain']/@value"/></STRONG></FONT>
              </TD>
            </TR>
