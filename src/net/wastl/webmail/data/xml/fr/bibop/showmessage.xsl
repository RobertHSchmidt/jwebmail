...
<IMG SRC="{$imgbase}/images/icona_mail.gif" BORDER="0" hspace="5" align="absmiddle"/><SPAN class="testoNero">Voir le message (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=messagelist">Aide</A>)</SPAN>
  ...
  <xsl:template match="MESSAGE">
	...
	<TD height="22" class="testoNero" width="87%" bgcolor="#D1D7E7">
      ...
      <TR>
	<TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">Réponse A:
	</TD>
	<TD height="22" class="testoNero" width="87%" bgcolor="#D1D7E7">
  ...
  <xsl:template match="PART">
	...
	<TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
	  <TR>
	    <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">Fichiers Attachés
	    </TD>
	    <TD height="22" class="testoNero" width="87%" bgcolor="#D1D7E7">
	...
	<TR>
	  <xsl:choose>
		...
		<TD width="30%" bgcolor="#697791" valign="middle">
		  <A HREF="{$base}/folder/showmsg?session-id={$session-id}&amp;folder-id={/USERMODEL/CURRENT[@type='folder']/@id}&amp;message-nr={@msgnr - 1}"> <SPAN class="testoBianco">Message précédent</SPAN>
		  </A>
		</TD>
		</xsl:when>
		<xsl:otherwise>
