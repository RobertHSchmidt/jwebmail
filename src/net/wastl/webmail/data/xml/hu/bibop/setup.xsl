        ...
        <FORM ACTION="{$base}/setup/submit?session-id={$session-id}" METHOD="POST">
          <TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
            ...
            <TR>
              ...
              <TD class="testoNero" bgcolor="#E2E6F0"><input class="testoNero" name="SETDEFAULT" type="submit" value="Alapértelmezetté tesz"/></TD>
              <TD class="testoNero" bgcolor="#D1D7E7"><input class="testoNero" name="DELETEEMAIL" type="submit" value="Töröl"/></TD>
            </TR>
            <TR>
              <TD bgcolor="#E2E6F0" class="testoNero">Új email cím:</TD>
