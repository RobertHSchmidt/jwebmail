...
import net.wastl.webmail.session.admin.AdminSession;
        ...
        */
        try {
            ...
            while(enum2.hasMoreElements()) {
                ...
                getLogger().log(Logger.LOG_INFO,"Parameter "+s);
            }
...
//          while(enum2.hasMoreElements()) {
//              String s=(String)enum2.nextElement();
//              getLogger().log(Logger.LOG_INFO,"Attribute "+s);
//          }
            ...
            if(req.getContentType() != null &&
               req.getContentType().toUpperCase().startsWith("MULTIPART/FORM-DATA")) {
                ...
                while((p = mparser.readNextPart()) != null) {
                    ...
                    getLogger().log(Logger.LOG_INFO,"Parameter "+p.getName());
                }
            ...
            try {
                ...
                getLogger().log(Logger.LOG_INFO,"Connection to "+addr.toString()+
...
//              out.close();
            ...
            e.printStackTrace();
            getLogger().log(Logger.LOG_INFO,"Connection to "+addr.toString()+" closed");
            throw new ServletException("Error: "+e.getMessage(),e);
        }
    }
