        ...
        <FORM ACTION="{$base}/admin/user/edit?session-id={$session-id}" METHOD="POST">
          ...
          <TABLE WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
            <TR bgcolor="#dddddd">
              <xsl:choose>
                <xsl:when test="$ud != ''">
                  <TD COLSPAN="4" ALIGN="center"><FONT SIZE="+1"><STRONG>Modificaci&#243;n de un usuario <xsl:value-of select="$ud/LOGIN"/>, Dominio <xsl:value-of select="$ud/USER_DOMAIN"/></STRONG></FONT></TD>
                </xsl:when>
                <xsl:otherwise>
                  <TD COLSPAN="4" ALIGN="center"><FONT SIZE="+1"><STRONG>Creaci&#243;n de un nuevo usuario en el dominio <xsl:value-of select="$ud/USER_DOMAIN"/></STRONG></FONT></TD>
                </xsl:otherwise>
              </xsl:choose>
            </TR>

            <TR>
              <TD COLSPAN="4" BGCOLOR="lightblue" ALIGN="CENTER"><EM><FONT SIZE="+1">Preferencias generales</FONT></EM></TD>
            </TR>
            ...
            <TR>
              <TD COLSPAN="4" BGCOLOR="lightblue" ALIGN="CENTER"><EM><FONT SIZE="+1">Preferencias de pantalla</FONT></EM></TD>
            </TR>

            <TR>
              <TD><STRONG>Mensajes por p&#225;gina</STRONG></TD>
              <TD><INPUT TYPE="TEXT" NAME="intvar%max show messages" SIZE="3" VALUE="{$ud/INTVAR[@name='max show messages']/@value}"/></TD>

              <TD><STRONG>Tama&#241;o de los iconos de la barra de navegaci&#243;n</STRONG></TD>
              <TD><INPUT TYPE="TEXT" NAME="intvar%icon size" SIZE="3" VALUE="{$ud/INTVAR[@name='icon size']/@value}"/></TD>
            </TR>

            <TR>
              <TD><STRONG>Mostrar informaci&#243;n adicional</STRONG></TD>
              <TD>
                <xsl:choose>
              ...
              <TD><STRONG>Mostrar atributos de im&#225;genes</STRONG></TD>
              <TD>
                <xsl:choose>
            ...
            <TR>
              <TD><STRONG>Filtrar JavaScript</STRONG></TD>
              <TD>
                <xsl:choose>
              ...
              <TD><STRONG>Poner marcas a los mensajes</STRONG></TD>
              <TD>
                <xsl:choose>
            ...
            <TR>
              <TD><STRONG>Cortar l&#237;neas (al mostrar y redactar)</STRONG></TD>
              <TD>
                <xsl:choose>
              ...
              <TD><STRONG>Longitud m&#225;x. de l&#237;nea</STRONG></TD>
              <TD><INPUT TYPE="TEXT" NAME="intvar%max line length" SIZE="3" VALUE="{$ud/INTVAR[@name='max line length']/@value}"/></TD>
            </TR>

            <TR>
              <TD COLSPAN="4" BGCOLOR="lightblue" ALIGN="CENTER"><EM><FONT SIZE="+1">Preferencias de redacci&#235;n</FONT></EM></TD>
            </TR>

            <TR>
              <TD><STRONG>Direcci&#243;n de correo:</STRONG></TD>
            ...
            <TR bgcolor="#dddddd">
              <TD COLSPAN="4" ALIGN="center"><FONT SIZE="+1"><STRONG>Aceptar cambios</STRONG></FONT></TD>
            </TR>
