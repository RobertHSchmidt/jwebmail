...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="MESSAGELIST">
        <TR>
          ...
          <TD  width="7%" class="testoGrande" bgcolor="#A6B1C0">Flags</TD>
          <TD width="28%" class="testoGrande" bgcolor="#A6B1C0">Subject</TD>
          <TD width="25%" class="testoGrande" bgcolor="#A6B1C0">Sender</TD>
          <TD width="25%" class="testoGrande" bgcolor="#A6B1C0">Date</TD>
          <TD width="5%" class="testoGrande" bgcolor="#A6B1C0">Size</TD>
        </TR>
