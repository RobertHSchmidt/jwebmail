...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" version="1.0">
  <xsl:output method="html" indent="yes" xalan:content-handler="org.apache.xalan.serialize.SerializerToHTML"/>
    ...
    <HTML>
      <HEAD>
        <TITLE>Buz&#243;n de WebMail para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/>: Title Frame</TITLE>
        ...
        <TABLE width="100%" border="0" cellspacing="0" cellpadding="0">
          <TR>
            ...
            <TD width="16%" valign="top" align="right" bgcolor="#697791" background="{$imgbase}/images/curva_alto.gif" class="mailbox">
              <SPAN class="mailbold"><xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/></SPAN>'S<BR/>MAILBOX
            </TD>
