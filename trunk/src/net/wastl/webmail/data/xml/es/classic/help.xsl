...
<!-- Test whether the user has choosen a specific help topic or wants to display the whole
            ...
            <TR>
              <TD COLSPAN="2" ALIGN="CENTER">
                <STRONG>
                  <EMPH>Este sistema usa <xsl:apply-templates select="/USERMODEL/STATEDATA/VAR[@name='java virtual machine']"/> en <xsl:apply-templates select="/USERMODEL/STATEDATA/VAR[@name='operating system']"/></EMPH>
                </STRONG>
              </TD>
            </TR>
            <TR>
