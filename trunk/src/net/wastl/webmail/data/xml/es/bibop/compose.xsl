...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xalan="http://xml.apache.org/xslt" version="1.0">
  ...
  <xsl:variable name="work" select="/USERMODEL/WORK/MESSAGE[position()=1]"/>
    ...
    <HTML>
      <HEAD>
        <TITLE>Buz&#243;n de WebMail para <xsl:value-of select="/USERMODEL/USERDATA/FULL_NAME"/>: Redactar mensaje <xsl:value-of select="/USERMODEL/CURRENT[@type='message']/@id"/></TITLE>
        ...
        <FORM ACTION="{$base}/send?session-id={$session-id}" METHOD="POST">
          <TABLE width="100%" border="0" cellspacing="2" cellpadding="4">
            <TR>
              ...
              Redactar mensaje (<A HREF="{$base}/help?session-id={$session-id}&amp;helptopic=compose">Ayuda</A>)
                </TD>
            </TR>
            <TR>
           ...
           <TR>
             <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">De:</TD>
            ...
            <TR>
              <TD height="22" class="testoGrande" width="13%" bgcolor="#E2E6F0">Para:</TD>
              <TD height="22" class="testoNero" width="87%" bgcolor="#E2E6F0">
            ...
            <TR>
              <TD height="22" class="testoNero" width="13%" bgcolor="#E2E6F0">
                  <INPUT TYPE="SUBMIT" class="testoNero" VALUE="Attach files..." NAME="ATTACH"/>
                </TD>
              <TD class="testoNero" align="right" width="87%" bgcolor="#E2E6F0">
                  <INPUT TYPE="SUBMIT" class="testoNero" VALUE="Send message..." NAME="SEND"/>
                </TD>
            </TR>
            <TR>
