              ...
              <TABLE width="400" border="0" cellspacing="0" cellpadding="0" height="250">
                ...
                <TR>
                  <TD colspan="2" align="center" height="50" bgcolor="#7B889F" width="400" class="testoBianco">
                    ...
                    la configuración en el disco.
                    Si no ves la <SPAN class="bold">pantalla de conexi&#243;n</SPAN> en unos pocos segundos, por favor
                    <A HREF="{/USERMODEL/STATEDATA/VAR[@name='base uri']/@value}/"><SPAN class="testoScuro">haz click aqu&#237;</SPAN></A>.
                  </TD>
                </TR>
                <TR>
